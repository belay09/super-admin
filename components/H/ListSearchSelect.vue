...
<template>
  <div class="relative">
    ...
    <ul
      ...
      v-show="show"
      :class="supporter"
      class="px-2 absolute z-50 w-full bg-white  :bg- -secondary  border-r-2 border-l-2 border-b-2 border-new-tale/50 scrollbar scrollbar-thin scrollbar-track-rounded-full scrollbar-track-primary shadow-lg max-h-56 h-auto rounded-br-xl rounded-b-xl text-base overflow-auto"
    >
