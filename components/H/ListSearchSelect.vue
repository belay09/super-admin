  ...
  <div class="relative">
    ...
    <div class="relative rounded-md shadow-sm font-body">
      ...
      <button
        ...
        :disabled="disabled"
        @click="open"
        class="bg-white text-base font-normal relative w-full border rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1"
        :class="[
          errorMessage
            ? 'focus:ring-red-500 focus:border-red-500 hover:border-red-500 border-red-500'
            : 'focus:ring-primary-600  focus:border-primary-600 hover:border-primary-600 border-gray-300 border-1 ',
    ...
    <ul
      ...
      v-show="show"
      :class="supporter"
      class="absolute z-50 w-full bg-white border-r-2 border-l-2 border-b-2 border-primary-600/50 scrollbar scrollbar-thin scrollbar-track-rounded-full scrollbar-track-primary-600 shadow-lg max-h-56 h-auto rounded-br-xl rounded-b-xl text-base overflow-auto"
    >
      <li class="flex justify-center items-center px-2">
        <input
          ...
          :name="props.name"
          id="email"
          class="my-1 shadow-sm focus:ring-primary-600 focus:border-primary-600 block sm:text-sm w-full border-gray-300 rounded-md font-body"
