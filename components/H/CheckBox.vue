    ...
    <div class="relative flex items-center">
      <div class="flex items-center h-5">
        <input
          ...
          :name="name"
          :type="type"
          class="text-green-500 appearance-none hover:outline-none border-red-500 outline-none focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-0 rounded text-md duration-200"
          :class="props.class"
        />
      </div>
