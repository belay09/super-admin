...
<template>
  ...
  >
    ...
    >
      ...
      >
        <Icon name="tdesign:refresh" class="text-xl text-primary-800"></Icon>
      </div>
    </div>
    <div
      v-else-if="loading"
    ...
    >
      <Icon name="eos-icons:bubble-loading" class="text-6xl text-primary-300" />
    </div>
    <div
      
    v-else
      @click="open"
      class="flex cursor-pointer flex-col items-center justify-center w-full space-y-4 mt-2"
    >
      <p
      ...
      >
        <span class="text-blue-600 "
          ><Icon
            ...
            class="text-3xl text-primary-500 my-auto self-center"
          />
        </span>
      </p>
