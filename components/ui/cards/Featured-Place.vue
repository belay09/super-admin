...
editError((error) => {
  ...
  if (error.message.includes("database query error")) {
	Message = "in this weak gap you can't extend the date of this place";
...
onMounted(() => {
  ...
  startDate.value = getFeaturedPlace().startDate;
...
<template>
  ...
  <div
    ...
    class="flex flex-col border max-w-lg hover:border-primary-600 hover:shadow-md p-[25px] rounded-xl text-sm hover:cursor-pointer"
      ...
      <div class="flex w-full gap-3">
        ...
        <div class="flex flex-col w-full gap-2">
          ...
          <div class="flex flex-wrap gap-x-4 gap-y-2">
            <div class="px-2 py-1 bg-blue-300 rounded-sm">
