...
<template>
  <div
    ...
    class="flex items-center py-1 px-4 text-sheger_dark_gray-200 space-x-2 secondary-background rounded-full dark:text-white cursor-pointer duration-300"
    :class="{
      ' iphone5:bg-primary-600 text-white':
        index === currentShowedLocationIndex,
    }"
  >
