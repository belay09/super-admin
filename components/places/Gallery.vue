...
<template>
	<div class="relative">
		<img
			:src="media?.media?.url"
			class="w-full h-[22rem] object-cover hover:blur-sm"
			loading="lazy"
		...
		<button
			...
			@mouseover="showDelete"
			@mouseleave="hideDelete"
			class="absolute inset-0 z-40 w-32 h-12 px-4 py-3 mx-auto my-auto text-white border border-white rounded-md"
		>
			Delete
		</button>
	</div>
