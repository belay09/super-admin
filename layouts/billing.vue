...
<template>
	<!-- ----------------To use notify inside the pages------------ -->
	<HNotification />
	<div class="">
		<div class="flex">
			<div
			...
			>
				...
				<div
					class="fixed top-0 left-0 flex flex-col h-screen min-w-[300px] px-6 overflow-y-auto border-r border-gray-200 grow gap-y-32 bg-primary-600 scroll"
				>
					<NuxtLink
						to="/app"
