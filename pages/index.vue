...
<template>
  <div class="flex h-screen">
    <!----------------------------------Left Side Image ---------------------------->
    <div
      class="flex-[30%] bg-primary-600 gap-4 flex flex-col items-center justify-center px-10"
    >
      <img src="/images/static/admin_login.png" alt="image" />
      <p class="text-5xl text-white capitalize text-center font-poppins leading-tight tracking-wide ">
  Sheger gebeta Administrator
</p>
    </div>
